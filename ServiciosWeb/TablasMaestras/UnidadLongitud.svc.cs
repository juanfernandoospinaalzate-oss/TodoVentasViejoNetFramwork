// -----------------------------------------------------------------------
// <copyright file="UnidadLongitud.svc.cs" company="Todo Ventas Colombia">
...
namespace ServiciosWeb.TablasMaestras
{
    ...
    public class UnidadLongitud : Contratos.IUnidadLongitud
    {
        ...
        {
            Validacion.TablasMaestras.UnidadLongitud unidadesLongitud = new Validacion.TablasMaestras.UnidadLongitud();
