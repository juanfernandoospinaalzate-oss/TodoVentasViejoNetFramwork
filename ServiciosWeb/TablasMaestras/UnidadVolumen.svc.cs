// -----------------------------------------------------------------------
// <copyright file="UnidadVolumen.svc.cs" company="Todo Ventas Colombia">
...
namespace ServiciosWeb.TablasMaestras
{
    ...
    public class UnidadVolumen : Contratos.IUnidadVolumen
    {
        ...
        {
            Validacion.TablasMaestras.UnidadVolumen unidadesVolumen = new Validacion.TablasMaestras.UnidadVolumen();
