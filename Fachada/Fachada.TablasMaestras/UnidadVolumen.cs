...
namespace Fachada.TablasMaestras
{
    ...
    public class UnidadVolumen : Contratos.IUnidadVolumen
    {
        ...
        {
            ServicioUnidadVolumen.UnidadVolumenClient unidadesVolumen = null;
            try
            {
                unidadesVolumen = new ServicioUnidadVolumen.UnidadVolumenClient();
            }
            catch (Exception)
            {
            ...
            {
                if (unidadesVolumen != null)
                {
                    ((IDisposable)unidadesVolumen).Dispose();
                }
            }
        ...
        public System.Collections.ObjectModel.ReadOnlyCollection<Entidades.UnidadVolumen> Listar()
        {
            ...
            {
                unidadesVolumen = new ServicioUnidadVolumen.UnidadVolumenClient();
                listaReadOnlyunidadVolumen = unidadesVolumen.Listar();
            }
