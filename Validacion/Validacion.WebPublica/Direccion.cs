...
namespace Validacion.WebPublica
{
    ...
    public class Direccion : ContratosWeb.IDireccion
    {
        ...
        {
            ReglasDENegocio.WebPublica.Direccion objdireccion = new ReglasDENegocio.WebPublica.Direccion();
        ...
        {
            ReglasDENegocio.WebPublica.Direccion direccion = new ReglasDENegocio.WebPublica.Direccion();
