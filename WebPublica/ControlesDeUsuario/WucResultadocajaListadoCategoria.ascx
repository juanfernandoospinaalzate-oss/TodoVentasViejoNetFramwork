<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WucResultadocajaListadoCategoria.ascx.cs" Inherits="WebPublica.ControlesDeUsuario.WucResultadocajaListadoCategoria" %>
